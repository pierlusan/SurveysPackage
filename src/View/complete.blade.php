...
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        <div class="card mio-colore-personalizzato">
            <div class="container">
                <form
                    action="{{route('surveys.saveResponse',['survey'=>$survey->id,'module'=>$module->id ?? 'fallback_value'])}}"
                    method="post">
                    @csrf
                    <div class="card-header rounded-3 bg-white mt-3">
                                        ...
                                        <div class="card-header mt-2 rounded-5 bg-white">
                                            <div class="row">
                                                @if($question->type == 'linear_scale')
                                                    <div class="container">
                                                        <div class="colored-bar-question rounded-5"></div>
                                                        <div class="card-body">
                                                                ...
                                                                @foreach($question->answers as $answer)
                                                                    <div class="form-check mb-2">
                                                                        ...
                                                                        <input class="form-check-input" type="radio"
                                                                               name="responses[{{$key}}][answer]"
                                                                               value="{{$answer->id}}"
                                                                               id="radioExample{{$key}}" required>
                                                                        <label class="form-check-label"
                                                                               for="radioExample{{$key}}">
                                                                            {{$answer->answer}}
                                                                        </label>
                                                                        ...
                                                                        <input type="hidden"
                                                                               name="responses[{{$key}}][questionPoints]"
                                                                               value="{{$question->points }}">

                                                                        <input type="hidden"
                                                                               name="responses[{{$key}}][next]"
                                                                               value="{{$answer->next_module_id}}">

                                                                        <input type="hidden"
                                                                               name="responses[{{$key}}][answerValue]"
                                                                               value="{{$answer->value }}">
                                                                    </div>
                                                                @endforeach
                                                            </div>
